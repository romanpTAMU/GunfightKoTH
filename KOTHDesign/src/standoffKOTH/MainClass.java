...
public class MainClass {
	public static void main(String[] args) throws InterruptedException {
		...
		for(int n=0;n<bots.length;n++)
		{
			...
			{
				scoreSaver.put(nBot.getClass(),scoreSaver.get(nBot.getClass())+1+players.size()-nBot.getAliveEnemies().size());
				/*
				 * Get points (1 for each dead bot other than yourself, 2 for winning the round)
				 */
				}
			}
